...
// var sanitizeNames = _.compose(_.map(_underscore), _.map(_toLowerCase), _.map(_.prop('name')))
...
var myAppend = _.flip(_.concat)
var fastestCar = _.compose(myAppend(' is the fastest'), _.prop('name'), _.last, _.sortBy(_.prop('horsepower')))
